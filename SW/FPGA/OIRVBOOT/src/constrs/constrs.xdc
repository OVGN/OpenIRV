...
set_property DRIVE 4 [get_ports hram_r0_reset_n]
set_property DRIVE 4 [get_ports hram_r0_cs_n]
...
set_property DRIVE 4 [get_ports hram_r1_reset_n]
set_property DRIVE 4 [get_ports hram_r1_cs_n]
...
set_property DRIVE 4 [get_ports cnfg_cs_n]
set_property DRIVE 4 [get_ports cnfg_mosi_miso_0]
set_property DRIVE 4 [get_ports cnfg_miso_miso_1]
set_property DRIVE 4 [get_ports cnfg_miso_2]
set_property DRIVE 4 [get_ports cnfg_miso_3]
...
set_property DRIVE 4 [get_ports lcd_led_ctrl]
set_property DRIVE 4 [get_ports lcd_spi_dat]
set_property DRIVE 4 [get_ports lcd_spi_sck]
set_property DRIVE 4 [get_ports lcd_spi_rst_n]
...
set_property DRIVE 4 [get_ports sdio_cmd]
set_property DRIVE 4 [get_ports sdio_clk]
set_property DRIVE 4 [get_ports {sdio_dat[*]}]
...
set_property DRIVE 4 [get_ports sensor_bias_boost_pwr_ena]
set_property DRIVE 4 [get_ports sensor_core_pwr_ena]
set_property DRIVE 4 [get_ports sensor_bias_pwr_ena]
set_property DRIVE 4 [get_ports sensor_io_pwr_ena_n]
set_property DRIVE 4 [get_ports sensor_bias_volt_sel]
...
set_property DRIVE 4 [get_ports shtr_drive_ena]
set_property DRIVE 4 [get_ports focus_drive_ena]
...
set_property DRIVE 4 [get_ports gpio_aux_spi_sck]
set_property DRIVE 4 [get_ports gpio_aux_spi_cs_0]
set_property DRIVE 4 [get_ports gpio_aux_spi_cs_1]
set_property DRIVE 4 [get_ports gpio_aux_spi_miso]
set_property DRIVE 4 [get_ports gpio_aux_spi_mosi]
...
set_property DRIVE 4 [get_ports gpio_aux_i2c_sda]
set_property DRIVE 4 [get_ports gpio_aux_i2c_scl]
...
set_property DRIVE 4 [get_ports ext_gpio_0_buf]
set_property DRIVE 4 [get_ports ext_gpio_0_dir]
set_property DRIVE 4 [get_ports ext_gpio_0_oc]
...
set_property DRIVE 4 [get_ports ext_gpio_1_buf]
set_property DRIVE 4 [get_ports ext_gpio_1_dir]
set_property DRIVE 4 [get_ports ext_gpio_1_oc]
...
set_property DRIVE 4 [get_ports pwr_fd_clk]
set_property DRIVE 4 [get_ports pwr_fd_dat]
